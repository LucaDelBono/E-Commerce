                ...
                <div class="mx-auto w-full flex-none lg:max-w-2xl xl:max-w-4xl">
                        ...
                        <div class="space-y-6">
                                ...
                                <div wire:key="{{ $cartItem->id }}"
                                    ...
                                    <div
                                        ...
                                        <a href="#" class="shrink-0 md:order-1">
                                            <img class="h-20 w-20" src="{{ $cartItem->item->getImageUrl() }}" />
                                        </a>
                            ...
                            <div class="mx-auto mt-6 max-w-4xl flex-1 space-y-6 lg:mt-0 lg:w-full">
                                <div class="space-y-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm sm:p-6">
                                    <p class="text-xl font-semibold text-gray-900">Totale
                                        provvisorio({{ $totalQuantity }} articoli)</p>
                                    <div class="space-y-4">
                                        <div class="space-y-2">
                                            <dl class="flex items-center justify-between gap-4">
                                                <dt class="text-base font-normal text-gray-500">Prezzo</dt>
                                                <dd class="text-base font-medium text-gray-900">{{ $totalPrice }} €
                                                </dd>
                                            </dl>
                                        </div>
                    ...
                    @else
                        <div class="flex mt-32 items-center flex-col gap-4">
                            <p class="text-xl font-bold">Non hai articoli nel carrello!</p>
